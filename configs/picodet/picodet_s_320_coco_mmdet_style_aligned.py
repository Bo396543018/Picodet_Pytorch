model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint='/mnt/Models/pretrained/mmdet/ESNet_x0_75_pretrained_mmdet_format.pth')),
    neck=dict(
        type='CSPPAN',
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(256, 256), (288, 288), (320, 320), (352, 352), (384, 384)], multiscale_mode='value', keep_ratio=False),
